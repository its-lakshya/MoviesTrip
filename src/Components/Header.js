      ...
      <div className="flex justify-between mx-28 pt-2  max-md:mx-12 max-lg:mx-16 max-sm:mx-4 ">
        ...
        <div className="flex flex-col  w-72 ">
          <div className="flex justify-between ">
            ...
            <div className="flex justify-evenly items-center text-xl [&>*]:cursor-pointer mt-3 gap-6 max-sm:mt-4 max-sm:gap-2">
              <BiSearch
                className="hover:text-red-800 text-2xl max-sm:text-lg "

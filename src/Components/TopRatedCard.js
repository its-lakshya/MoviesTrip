  ...
  return (
    <div className="animate-horizontalAutoScrollRight-infinite">
      ...
      >
        ...
        />
        <div className="bg-gradient-to-t font-normal capitalize from-black to-transparent pl-2 max-sm:pl-1 transition-all ease-in-out delay-150 hover:bg-gradient-to-t hover:from-transparent hover:to-transparent">
